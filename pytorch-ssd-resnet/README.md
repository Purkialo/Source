```mytrain bash
python train_ssd.py --datasets /home/student/pydata/train/VOC2007/ --validation_dataset /home/student/pydata/test/VOC2007/
python train_ssd.py --datasets /home/student/pydata/train/VOC2007/ /home/student/pydata/train/VOC2012/ /home/student/pydata/train/VOC_COCO/ --validation_dataset /home/student/pydata/test/VOC2007/ --base_net models/resnet50-base.pth 

python train_ssd.py --datasets /home/student/pydata/train/VOC_COCO/ --validation_dataset /home/student/pydata/test/VOC2007/ --base_net models/resnet50-base.pth 

python eval_ssd.py --dataset /home/student/pydata/test/VOC2007/ --trained_model models/resnet_ssd-Epoch-149-Loss-2.5046069671710334.pth --label_file models/voc-model-labels.txt

python run_ssd_example.py models/resnet_ssd-Epoch-149-Loss-2.5046069671710334.pth models/voc-model-labels.txt testpic/23
python mytest.py models/resnet_ssd-Epoch-149-Loss-2.5128614703814187.pth models/voc-model-labels.txt
...
python run_ssd_example.py mobilenet-v1-ssd models/gun_model_2.21.pth models/open-images-model-labels.txt gun1.jpg
```
...
```bash
python train_ssd.py --datasets ~/data/train/VOC2007/ --validation_dataset ~/data/test/VOC2007/ --net "vgg16-ssd" --base_net models/vgg16_reducedfc.pth  --batch_size 24 --num_epochs 150 --scheduler cosine --lr 0.0012 --t_max 150 --validation_epochs 5
```
