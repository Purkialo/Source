...
def main():
    ...
    # 定义个测试句子。
    test_en_text = "High fever attacks me every New Year's Day. Rest more to boost your immune system. Go to see a doctor evert New Year's Day. Get well soon and stay healthy! <eos>"
    print(test_en_text)
